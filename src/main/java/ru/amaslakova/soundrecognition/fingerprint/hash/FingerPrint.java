...
import ru.amaslakova.soundrecognition.fingerprint.hash.peak.Peak;
...
public class FingerPrint {
	 ...
	 */
	private List<HashedPeak> hashes;
	 ...
	 */
	public List<HashedPeak> getHashes() {
		if (this.hashes != null) {
			return this.hashes;
		}
		
		// get the spectrogram data
		double[][] spectrogram = this.audioFile.getSpectrogram().getData();
