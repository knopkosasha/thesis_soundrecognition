package ru.amaslakova.soundrecognition.config;
...
public class SwaggerConfig {
	...
	public Docket constructDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
			.select()
			.apis(RequestHandlerSelectors.basePackage("ru.amaslakova.soundrecognition.controller"))
